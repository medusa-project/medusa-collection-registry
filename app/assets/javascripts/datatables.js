 ...
 *   https://datatables.net/download/#bs/dt-1.10.11,b-1.1.2,b-colvis-1.1.2,cr-1.3.1
 *
 * Included libraries:
 *   DataTables 1.10.11, Buttons 1.1.2, Column visibility 1.1.2, ColReorder 1.3.1
 */
...
(function( $, window, document, undefined ) {
	...
	DataTable.ext = _ext = {
		 ...
		 *  @type string
		 */
		build:"bs/dt-1.10.11,b-1.1.2,b-colvis-1.1.2,cr-1.3.1",
