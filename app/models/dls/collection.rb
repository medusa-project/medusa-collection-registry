class Dls::Collection
  ...
  def best_admin_url
    ...
    return admin_items_url if HTTParty.head(items_url, timeout: 3).success?
    ...
    return admin_collection_url if (collection_response.success? or (403 == collection_response.code))
    return nil
  rescue
    return nil
  end
