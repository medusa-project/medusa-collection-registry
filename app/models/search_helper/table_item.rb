class SearchHelper::TableItem < SearchHelper::TableBase
  ...
  def columns
    [{header: 'Action', value_method: :action_buttons, unsortable: true},
     ...
     {header: 'E-Book Status', solr_field: :ebook_status, value_method: :search_ebook_status, searchable: true, shorten: true},
     {header: 'Reviewed By', solr_field: :reviewed_by, value_method: :search_reviewed_by, searchable: true, shorten: true},
