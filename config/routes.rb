Rails.application.routes.draw do
  ...
  resources :cfs_files, only: :show, concerns: %i(downloadable eventable fixity_checkable) do
    %i(create_fits_xml fits view preview_image preview_video preview_audio preview_pdf
        preview_pdf_content thumbnail galleria).each {|action| get action, on: :member}
