class ConvertCfsDirectoryToHaveParentAssociation < ActiveRecord::Migration
  def up
    ...
    ActiveRecord::Base.connection.execute("UPDATE cfs_directories SET parent_id=file_group_id, parent_type='FileGroup' where file_group_id IS NOT NULL")
  ...
  def down
    ...
    ActiveRecord::Base.connection.execute("UPDATE cfs_directories SET file_group_id=parent_id WHERE parent_type='FileGroup'")
