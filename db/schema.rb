...
ActiveRecord::Schema.define(version: 20150916152553) do
  ...
  create_table "cfs_files", force: :cascade do |t|
    ...
    t.datetime "fixity_check_time"
    t.string   "fixity_check_status"
  end
  ...
  add_index "cfs_files", ["fixity_check_status"], name: "index_cfs_files_on_fixity_check_status", using: :btree
  add_index "cfs_files", ["fixity_check_time"], name: "index_cfs_files_on_fixity_check_time", using: :btree
  ...
  create_table "workflow_accrual_comments", force: :cascade do |t|
  ...
  add_index "workflow_accrual_comments", ["user_id"], name: "index_workflow_accrual_comments_on_user_id", using: :btree
  add_index "workflow_accrual_comments", ["workflow_accrual_job_id"], name: "index_workflow_accrual_comments_on_workflow_accrual_job_id", using: :btree
