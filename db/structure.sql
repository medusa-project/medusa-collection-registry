...
--
-- Name: index_idb_ingest_jobs_on_staging_path; Type: INDEX; Schema: public; Owner: -
--

CREATE UNIQUE INDEX index_idb_ingest_jobs_on_staging_path ON idb_ingest_jobs USING btree (staging_path);
