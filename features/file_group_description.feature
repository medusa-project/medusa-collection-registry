Feature: File Group description
  ...
  Background:
    ...
    And the collection with title 'Dogs' has child file groups with fields:
      | external_file_location | file_format | total_file_size | total_files | description      | provenance_note     | title  | staged_file_location | external_id              | access_url                | private_description | contact_email      |
      | Main Library           | image/jpeg  | 100             | 1200        | main summary     | main provenance     | images | staging_dir/images   | external-main-library-id | http://access.example.com | private summary     | ruth@example.com   |
  ...
  Scenario: View a file group
    ...
    Then I should see all of:
      | image/jpeg | 1,200 | main summary | main provenance | images | external | staging_dir/images | external-main-library-id | 3da0fae0-e3fa-012f-ac10-005056b22849-8 | private summary | http://access.example.com | ruth@example.com |
  ...
  Scenario: Edit a file group
    ...
    And I should see all of:
      | 1,300 | Changed summary | Changed provenance | pictures | staging_dir/pics | external-dogs-id | http://new-access.example.com | changed secret description | pearl@example.com |
    And I should see none of:
      | 1,200 | main summary | main provenance | images | staging_dir/pictures | external-main-library-id | http://access.example.com | private summary | ruth@example.com |
