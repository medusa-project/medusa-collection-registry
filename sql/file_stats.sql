...
CREATE OR REPLACE VIEW cfs_directories_file_stats_two_ways AS
...
CREATE OR REPLACE VIEW cfs_directories_inconsistent_file_stats AS
SELECT * FROM cfs_directories_file_stats_two_ways
...
CREATE OR REPLACE VIEW bit_level_file_group_cfs_root_stats_two_ways AS
